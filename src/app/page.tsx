  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        ...
        {/* Our Latest Stories Section */}
        <section className="section-padding bg-white">
          <div className="container mx-auto px-4 lg:px-8">
            <h2 className="text-center mb-12 text-gray-900">Our Latest Stories</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              {/* Story 1 */}
              <Link href="/stories/style-guide" className="group block">
                <div className="relative aspect-[3/4] overflow-hidden mb-4">
                  <Image
                    src="/product.webp"
                    alt="Style Guide for Kids"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                  />
                </div>
                <h3 className="text-base font-semibold mb-2 text-gray-900">Style Guide for Every Season</h3>
                <p className="text-xs text-gray-600 mb-3">
                  Discover the perfect looks and styling tips to keep your little ones fashionable all year round.
                </p>
              ...
              {/* Story 2 */}
              <Link href="/stories/care-tips" className="group block">
                <div className="relative aspect-[3/4] overflow-hidden mb-4">
                  <Image
                    src="/product.webp"
                    alt="Care Tips"
              ...
              {/* Story 3 */}
              <Link href="/stories/seasonal-trends" className="group block">
                <div className="relative aspect-[3/4] overflow-hidden mb-4">
                  <Image
                    src="/product.webp"
                    alt="Seasonal Trends"
